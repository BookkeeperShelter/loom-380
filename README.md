...
```bash
git clone https://github.com/BookkeeperShelter/loom-380.git
cd loom-380
python setup.py
```
...
- [mock-json-schema](https://github.com/BookkeeperShelter/loom-380) —— Mock 数据生成
...
<!-- Last updated: 2026-06-06 16:37:03 -->
